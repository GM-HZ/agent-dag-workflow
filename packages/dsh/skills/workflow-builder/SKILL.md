...
6. Call `workflow_validate`, or `workflow_draft_validate` after an import. Fix only deterministic structural issues automatically. For unknown Tools/Nodes, ambiguous bindings, changed side effects, approval placement, or retry decisions, ask the user.
