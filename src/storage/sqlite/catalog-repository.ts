...
import type { MaterializedWorkflowTemplate, WorkflowTemplate } from '../../core/index.js'
import { parseWorkflowTemplate, stableJsonStringify } from '../../core/index.js'
import {
...
function encodeTemplate(template: WorkflowTemplate): string {
  return stableJsonStringify(template as unknown as import('../../core/index.js').JsonValue)
}
