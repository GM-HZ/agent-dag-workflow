...
本文描述当前 `main` 分支的 Host-neutral 架构。README 给出黄金使用路径，本文只解释稳定边界和执行语义；公开协议以 [Workflow Template v1](https://github.com/GM-HZ/agent-dag-workflow/blob/main/spec/workflow-template-v1.md) 为准。
